...
//	}
	...
	@GetMapping(path = "/clientes/{id}") //consulta determinado cliente por id
	...
	@GetMapping(path = "/clientes") //consulta clientes por nome, "chave valor"
	...
	@PutMapping(path = "/clientes/{id}") //faz alteração de determinado cliente que foi buscado pelo id
